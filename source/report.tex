...
\title{Turkish Question Generation}
\author{Erdal Dogan \and Alp Gokcek \and Mert Komurcuoglu}
...
\begin{document}
	...
	\begin{table}[h]
		...
		\begin{tabular}{| c | c | c |}
			...
			\hline
		\end{tabular}
	\caption{This is a sample table caption. Use Insert/Caption to add table captions. Table captions are provided at the top of the table.}
	\end{table}
	...
	\begin{figure}[h]
		...
		\caption{Sample figure. Use Insert/Caption to insert figure captions}
	\end{figure}
	...
	Describe what are the risks of completing the project successfully. Identify the risks, their impacts and likelihoods. Describe how to avoid these risks and what to do if the risk occurs. 
